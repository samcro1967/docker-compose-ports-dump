# dcpd_run_failure_tests.sh
#!/bin/bash

LOG_FILE="dcpd_run_failure_tests.log"
...
# Initialize the counters and the array
num_passed=0
num_failed=0
failed_tests=()
...
test_cases=(
    "python3 dcpd_main.py -d -e"
    "python3 dcpd_main.py -d -n"
    "python3 dcpd_main.py -d -s"
    "python3 dcpd_main.py -d -o"
    "python3 dcpd_main.py -e -s"
    "python3 dcpd_main.py -e -d"
    "python3 dcpd_main.py -e -o"
    "python3 dcpd_main.py -n -s"
    "python3 dcpd_main.py -n -d"
    "python3 dcpd_main.py -n -o"
    "python3 dcpd_main.py -s -d"
    "python3 dcpd_main.py -s -e"
    "python3 dcpd_main.py -s -n"
    "python3 dcpd_main.py -s -o"
)
